...
def ensure_world_cup_schema(cursor):
    ...
    add_column(cursor, "world_cup_progress", "cooldown_end", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "group_match_num", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "p_points", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "p_gf", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "p_ga", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp1_id", "TEXT")
    add_column(cursor, "world_cup_progress", "opp1_points", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp1_gf", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp1_ga", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp2_id", "TEXT")
    add_column(cursor, "world_cup_progress", "opp2_points", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp2_gf", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp2_ga", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp3_id", "TEXT")
    add_column(cursor, "world_cup_progress", "opp3_points", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp3_gf", "INTEGER DEFAULT 0")
    add_column(cursor, "world_cup_progress", "opp3_ga", "INTEGER DEFAULT 0")
