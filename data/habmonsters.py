...
MONSTER_SKILLS = {
    ...
    # ==========================================
    "invocar_goblins": {"nome": "Chamado da Horda", "tipo": "buff", "alvo": "self", "efeito": {"buff_atk": 25, "buff_spd": 15, "turnos": 2, "invocar": {"id": "goblin_guerreiro", "nome": "Goblin Conjurado", "quantidade": 2, "hp_percent": 0.4, "atk_percent": 0.5, "comportamento": "atacar", "turnos": 3}}, "cooldown": 3, "uso_maximo": 2},
    "dano_area_3_turnos": {"nome": "Maldição Espalhada", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_matk": 1.2, "dot": {"tipo": "maldicao", "dano_matk": 40, "turnos": 3}}},
    ...
    "tornado_de_fogo": {"nome": "Tornado de Fogo", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_matk": 1.5, "dot": {"tipo": "queimadura", "dano_matk": 80, "turnos": 2}}},
    ...
    # ==========================================
    "ignorar_matk": {"nome": "Imunidade Arcana", "tipo": "passiva", "alvo": "self", "efeito": {"ignora_dano_magico": True, "turnos": -1}},
    ...
    "invocar_horda_goblin": {"nome": "O Rei Ordena!", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_atk": 2.0, "chance_stun": 0.30, "invocar": {"id": "goblin_berserk", "nome": "Goblin de Elite", "quantidade": 2, "hp_percent": 0.5, "atk_percent": 0.6, "comportamento": "atacar", "turnos": 3}}, "cooldown": 3, "uso_maximo": 2},
    ...
    "dano_area_constante": {"nome": "Aura de Decadência", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_matk": 1.0, "dot": {"tipo": "trevas", "dano_matk": 150, "turnos": 3}}},
    "prisao_das_almas": {"nome": "Prisão das Almas", "tipo": "debuff", "alvo": "inimigo_maior_atk", "efeito": {"stun_turnos": 3, "debuff_atk": 50}},
    ...
    "tempestade_carmesim": {"nome": "Tempestade Carmesim", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_matk": 2.5, "dot": {"tipo": "sangramento", "dano_matk": 300, "turnos": 3}}},
    ...
    "veneno_ancestral": {"nome": "Veneno Ancestral", "tipo": "dano", "alvo": "todos_inimigos", "efeito": {"multiplicador_matk": 1.5, "dot": {"tipo": "veneno", "dano_matk": 400, "turnos": 4}, "corta_cura": True}},
    ...
    "coracao_congelado": {"nome": "Coração Congelado", "tipo": "passiva", "alvo": "self", "efeito": {"imune_cc": True, "reflete_dano": 50}},
    
    "necromancia_suprema": {"nome": "Necromancia Suprema", "tipo": "buff", "alvo": "self", "efeito": {"buff_atk": 50, "buff_matk": 50, "buff_spd": 50, "turnos": 4}},
    "toque_da_morte": {"nome": "Toque da Morte", "tipo": "insta_kill", "alvo": "unico_inimigo", "efeito": {"executa_abaixo_percent": 50}},
